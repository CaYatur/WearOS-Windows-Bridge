...
class BridgeMediaService : MediaSessionService() {
 ...
 override fun onCreate() {
  ...
  bridge = FailoverBridgeClient(this, { state -> state.media?.let(remotePlayer::update) }, { transport -> BridgeStatus.set(this,transport); remotePlayer.setConnected(transport != "Disconnected") })
